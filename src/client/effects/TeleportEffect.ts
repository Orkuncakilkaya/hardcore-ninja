...
export class TeleportEffect {
     ...
     */
    createTrail(startPos: THREE.Vector3, endPos: THREE.Vector3): { trail: THREE.Line, trailParticles: THREE.Points } {
        // Create trail line
     ...
     */
    updateTrail(trail: THREE.Line, trailParticles: THREE.Points, startPos: THREE.Vector3, currentPos: THREE.Vector3): void {
        // Update trail line
