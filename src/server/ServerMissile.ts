...
export class ServerMissile {
    ...
    constructor(id: string, ownerId: string, startPosition: THREE.Vector3, targetId: string | null, initialDirection: THREE.Vector3) {
        this.id = id;
    ...
    private checkCollisions(nextPosition: THREE.Vector3, entityManager: ServerEntityManager): boolean {
